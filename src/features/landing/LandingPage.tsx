      ...
      <section className="companies section-dark" id="companies">
        <div className="container section-pad dual-grid dual-grid--reverse">
          <div className="hiring-shift" role="group" tabIndex={0} aria-label={dictionary.companies.comparison.ariaLabel}>
            ...
            <div className="hiring-shift__grid">
              <article className="hiring-lens hiring-lens--cv">
                <div className="hiring-lens__label">
                  <span className="hiring-lens__dot" aria-hidden="true" />
                  {dictionary.companies.comparison.cvTitle}
                </div>
                <div className="hiring-lens__stack">
                  {dictionary.companies.comparison.cvSignals.map((item, index) => (
                    <div className="hiring-signal hiring-signal--muted" key={item}>
              ...
              <div className="hiring-shift__bridge" aria-hidden="true">
                <span className="hiring-shift__bridge-line" />
                <span className="hiring-shift__bridge-arrow"><ArrowRightIcon /></span>
              </div>

              <article className="hiring-lens hiring-lens--evidence">
                <div className="hiring-lens__label hiring-lens__label--accent">
                  <span className="hiring-lens__dot" aria-hidden="true" />
                  {dictionary.companies.comparison.evidenceTitle}
                </div>
                <div className="hiring-lens__stack">
                  {dictionary.companies.comparison.evidenceSignals.map((item, index) => (
                    <div className="hiring-signal hiring-signal--active" key={item}>
                      <span>{String(index + 1).padStart(2, "0")}</span>
                      <strong>{item}</strong>
                      <CheckIcon />
                    </div>
            ...
            <div className="hiring-shift__footer">
